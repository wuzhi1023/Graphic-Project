...
void Skybox::display()
{
   ...
   glBegin(GL_QUADS);
   glNormal3f( 0, 0, 1);
   glTexCoord2f(0.001,0.001); glVertex3f(-1,-1, 1);
   glTexCoord2f(0.999,0.001); glVertex3f(+1,-1, 1);
   glTexCoord2f(0.999,0.999); glVertex3f(+1,+1, 1);
   glTexCoord2f(0.001,0.999); glVertex3f(-1,+1, 1);
   glEnd();
   //  Back
